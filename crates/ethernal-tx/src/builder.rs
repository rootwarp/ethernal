...
use ethernal_core::network::Params;
...
mod tests {
    ...
    fn build_from_fixture() -> UnsignedTx {
        ...
        let entries = ethernal_core::deposit::entries_from_json(&raw).expect("parse fixture");
    ...
    fn golden_phase2_holesky_decode_and_verify() {
        ...
        let entries =
            ethernal_core::deposit::entries_from_json(&raw_fixture).expect("parse fixture");
